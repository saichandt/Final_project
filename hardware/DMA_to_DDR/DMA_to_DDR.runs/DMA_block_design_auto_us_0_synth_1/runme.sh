...
HD_PWD='C:/Users/kg540068/520_final/hardware/DMA_to_DDR/DMA_to_DDR.runs/DMA_block_design_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_block_design_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_block_design_auto_us_0.tcl
