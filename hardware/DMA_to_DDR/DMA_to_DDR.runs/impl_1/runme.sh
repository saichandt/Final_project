...
HD_PWD='C:/Users/kg540068/520_final/hardware/DMA_to_DDR/DMA_to_DDR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DMA_block_design_wrapper.tcl -notrace
